...
const sourcePaths=["packages/ai/prompts/itinerary-v5.ts","evals/itinerary/current-cases.ts","packages/ai/src/itinerary.ts","packages/ai/src/openai-itinerary.ts",
