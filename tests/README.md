...
- `e2e/` has no browser tests yet. Add Playwright once the screens stabilise.
...
| --- | --- | --- |
| Import | Save survives a failed job; retry does not duplicate results | Member 2 + Member 4 |
| Place confirmation | Two branches remain unresolved until traveler selects one | Member 2 |
| Planner | Closed venue, travel overlap and impossible booking explain conflicts | Member 3 |
| Editing | Locked dinner unchanged; stale edit rejected; revised day rechecked | Member 3 |
| Views | Same itinerary version/stop IDs in map, magazine and timeline | Member 1 |
...
| AI input | Embedded instructions cannot widen tool access or bypass output validation | Member 2 + Member 4 |
